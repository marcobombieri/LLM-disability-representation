...
path = os.path.join("..", "Results", "reddit_vs_ai_filtered.csv")
outp = os.path.join("..", "Results", "reddit_vs_ai_filtered_clustered_10_topics.csv")
...
with open(outp, mode="w", encoding="utf-8") as fo:
    ...
    for word, zscore in zip(words,zscores):
        ...
        "7. Social Issues & Poverty"
        "8. Life Events & Major Changes"
        "9. Negative Experiences & Suffering"
        "10. Miscellaneous"
