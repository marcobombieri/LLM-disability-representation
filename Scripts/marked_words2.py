...
unmarked ones. It save the results.
Example usage: 
python marked_words.py ../DatasetsCorpora/corpora_rdisability_ai.csv --target_val 'generated' --target_col 'disability' --unmarked_val 'reddit'
"""
...
def main():
    ...
    #print("Top words:")
    output_file_name = "../Results/merged_dis_no-dis360_reverse.csv"
    with open(output_file_name, mode="w", encoding="utf-8") as fo:
        writer = csv.writer(fo)
        for t in top_words_sorted:
            data = [t[0], str(round(t[1], 2))]
            writer.writerow(data)
            print(t[0] + " (" + str(round(t[1], 2)) + "); ", end=" ")
    #print(top_words)
